...
def _add_common_args(arg_parser):
    ...
    arg_parser.add_argument('--model_type', type=str, default="sinet", help="Type of model")
    ...
    arg_parser.add_argument('--head', type=int, default=4, help="attention head")
    arg_parser.add_argument('--prop_drop', type=float, default=0.1, help="Probability of dropout used in SiNET")
