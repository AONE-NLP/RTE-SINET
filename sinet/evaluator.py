...
from sinet import prediction
from sinet.entities import Document, Dataset, EntityType
from sinet.input_reader import BaseInputReader
from sinet.opt import jinja2
