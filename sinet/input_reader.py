...
from sinet.entities import Dataset, EntityType, RelationType, Entity, Relation, Document
from sinet.opt import spacy
...
class JsonInputReader(BaseInputReader):
    ...
    def _parse_relations(self, jrelations, entities, dataset) -> List[Relation]:
        ...
        for jrelation in jrelations:
            ...
            # create relation
            # print(entities[6]._entity_type._short_name)
