...
from sinet import input_reader
from sinet.sinet_trainer import SiNETTrainer
...
if __name__ == '__main__':
    ...
    if args.mode == 'train':
        ...
        raise Exception("Mode not in ['train', 'eval', 'predict'], e.g. 'python sinet.py train ...'")
